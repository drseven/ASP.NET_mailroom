...
@Injectable()
export class NegaraServiceProxy {
    private http: Http;
    private baseUrl: string;
    protected jsonParseReviver: (key: string, value: any) => any = undefined;
    ...
    getNegara(filter: string, limit: number): Observable<ListResultDtoOfNegaraListDto> {
        ...
        return this.http.request(url_, options_).flatMap((response_) => {
            return this.processGetNegara(response_);
        }).catch((response_: any) => {
            if (response_ instanceof Response) {
                try {
                    return this.processGetNegara(response_);
    ...
    protected processGetNegara(response: Response): Observable<ListResultDtoOfNegaraListDto> {
        const status = response.status; 
     ...
     * @return Success
     */
    createNegara(input: CreateNegaraInput): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/Negara/CreateNegara";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request(url_, options_).flatMap((response_) => {
            return this.processCreateNegara(response_);
        }).catch((response_: any) => {
            if (response_ instanceof Response) {
                try {
                    return this.processCreateNegara(response_);
    ...
    protected processCreateNegara(response: Response): Observable<void> {
        const status = response.status; 
...
export class ListResultDtoOfNegaraListDto implements IListResultDtoOfNegaraListDto {
    items: NegaraListDto[];

    constructor(data?: IListResultDtoOfNegaraListDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
        ...
        if (data) {
            if (data["items"] && data["items"].constructor === Array) {
                ...
                for (let item of data["items"])
                    this.items.push(NegaraListDto.fromJS(item));
            }
        }
    }

    static fromJS(data: any): ListResultDtoOfNegaraListDto {
        let result = new ListResultDtoOfNegaraListDto();
        result.init(data);
        return result;
    }
...
export interface IListResultDtoOfNegaraListDto {
    items: NegaraListDto[];
}

export class NegaraListDto implements INegaraListDto {
    name: string;
    code: string;
    isDeleted: boolean;
    ...
    constructor(data?: INegaraListDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): NegaraListDto {
        let result = new NegaraListDto();
        result.init(data);
        return result;
    }
...
export interface INegaraListDto {
    name: string;
    code: string;
    isDeleted: boolean;
    deleterUserId: number;
...
export class CreateNegaraInput implements ICreateNegaraInput {
    name: string;
    code: string;

    constructor(data?: ICreateNegaraInput) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): CreateNegaraInput {
        let result = new CreateNegaraInput();
        result.init(data);
        return result;
    }
